...
pub fn generate_thumbnail_image(file_str_path: &str) -> io::Result<String> {
    ...
    let file_extension: &str = file_path
        ...
        .to_str()
        .unwrap();
    let mut extra_arguments: &[&str] = &[];

    match file_extension.to_lowercase().as_str() {
        "png" | "jpg" | "jpeg" | "webp" | "heic" | "heif" => {
            extra_arguments = &["-vf", "crop='min(iw,ih):min(iw,ih)',scale=100:100"];
        }
